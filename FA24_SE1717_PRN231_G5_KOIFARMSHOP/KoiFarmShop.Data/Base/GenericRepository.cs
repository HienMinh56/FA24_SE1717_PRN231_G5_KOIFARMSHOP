...
namespace KoiFarmShop.Data.Base
{
    ...
    {
        protected FA24_SE1717_PRN231_G5_KOIFARMSHOPContext _context;

        public GenericRepository()
        {
            _context ??= new FA24_SE1717_PRN231_G5_KOIFARMSHOPContext();
        }

        public GenericRepository(FA24_SE1717_PRN231_G5_KOIFARMSHOPContext context)
        {
            _context = context;
        }
